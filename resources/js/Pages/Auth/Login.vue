    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-center">
            ...
            <Link
                ...
                class="inline-flex w-full px-4 py-2 pl-32 text-xs font-semibold text-gray-800 bg-white border border-gray-300 hover:bg-gray-100 focus:bg-gray-100"
            >
                <svg
