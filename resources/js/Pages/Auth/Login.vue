...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="uppercase text-center font-semibold pb-3 text-gray-800">Iniciar Sesión</div>
        <div class="text-center text-sm text-gray-600 pb-5">
            ¿Aun no tienes una cuenta?
            <Link :href="route('register')" class="text-gray-800 font-semibold hover:text-gray-600 hover:underline">
            Registrate aquí
            </Link>
        </div>
