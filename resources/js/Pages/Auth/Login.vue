...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="pb-5 text-sm text-center text-gray-600">
            ...
            <Link :href="route('register')" class="font-semibold text-gray-800 hover:text-gray-600 hover:underline">
            Registrate aquí
            </Link>
        </div>
        ...
        <div class="mb-4 text-center">
            <button @click="redirectToGoogle"
                ...
                </svg>&ensp;Continuar con Google
            </button>
        </div>
        <div class="flex items-center my-4">
            <div class="flex-grow border-t border-gray-300"></div>
            <span class="mx-2 text-xs text-gray-500">O</span>
            <div class="flex-grow border-t border-gray-300"></div>
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    ...
                    <span class="text-sm text-gray-600 ms-2">Mantener sesión activa</span>
                </label>
            </div>
