...
library.add(faTachometerAlt, faCity, faUsers, faTicket, faChalkboard, faBuilding, faChevronDown, faChevronUp);
...
<template>
    <div>
        ...
        <div class="flex min-h-screen bg-gray-100">
            <nav class="transition-all duration-[200ms] ease-in-out bg-white border-r border-gray-100"
                ...
                <div class="w-full py-4">
                    ...
                    <div class="flex flex-col">
                        <NavLink :href="route('dashboard')" :active="route().current('dashboard')"
                            class="flex items-center w-full h-12 px-4 space-x-2" :class="{
                        ...
                        <NavLink :href="route('usuario')" :active="route().current('usuario')"
                            ...
                            <span v-if="mostrarTextoSidebar">Soportes Técnicos</span>
                        </NavLink>
                        <NavLink :href="route('usuario')" :active="route().current('usuario')"
                            class="flex items-center w-full h-12 px-4 space-x-2" :class="{
                                'bg-gray-200 text-gray-800 border-none':
                            ...
                            <font-awesome-icon icon="users" class="text-lg" />
                            <span v-if="mostrarTextoSidebar">Docentes</span>
                        </NavLink>
                        <NavLink :href="route('ticket')" :active="route().current('ticket')"
                            ...
                            <span v-if="mostrarTextoSidebar">Tickets</span>
                        </NavLink>
            ...
            <div class="flex flex-col flex-1">
                <nav class="bg-white border-b border-gray-100">
                    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                        <button @click="interactuarSidebar"
                            ...
                            <Dropdown align="right" width="48">
                                <template #trigger>
                                    <button @click="interactuarDropdown"
                                        ...
                                        <font-awesome-icon icon="chevron-down" class="ml-2 text-gray-600" />
                                    </button>
                                </template>
                                <template #content>
